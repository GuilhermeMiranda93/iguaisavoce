...
<body>
    ...
    <div class="row">
        ...
        <div id="navbar" class="navbar col-md-2">
            ...
            <ul class="nav navbar-nav" role="navigation">
                <li class="navbar-header"><img class="img-max-x" src="<?php echo e(URL::asset('img/logo.png')); ?>"></li>
                ...
                <a href="<?php echo e(url('https://www.google.com.br')); ?>"><li><i class="fa fa-user" aria-hidden="true"></i> Novo Usuário</li></a>
                <a href="<?php echo e(url('https://www.google.com.br')); ?>"><li><i class="fa fa-sign-out" aria-hidden="true"></i> Sair</li></a>
    ...
    <!--Bootstrap-->
    <script src="<?php echo e(URL::asset('lib/bootstrap/js/bootstrap.min.js')); ?>"></script>

    <!--Dropzone-->
    <script src="<?php echo e(URL::asset('lib/dropzone/dropzone.js')); ?>"></script>

    <!-- Froala Editor -->
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.25.0/codemirror.min.js"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.25.0/mode/xml/xml.min.js"></script>
    <script src="<?php echo e(URL::asset('lib/froala-editor/js/froala_editor.pkgd.min.js')); ?>"></script>
