...
<div id="conteudo" class="conteudo painel col-md-10">
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<h3>Novo Áudio</h3>
				<form enctype="multipart/form-data" action="/painel/audio/sav" method="POST">
				{{csrf_field()}}
					...
					<div class="form-group">
						<label for="chamada_input">Descrição</label>
						<textarea name="chamada" class="form-control" id="chamada_input" rows="3"></textarea>
					</div>
					<div class="form-group">
						<label for="audio_input">Carregar Áudio</label>
						<input name="arquivo" accept="audio/*" type="file" class="form-control-file" id="audio_input" aria-describedby="fileHelp">
					</div>                       
